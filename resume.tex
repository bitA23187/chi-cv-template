...
%% basic personal info
\togglephoto{true} % 设置为 true 显示照片，false 不显示照片

\begin{namephoto}
\ifshowphoto
  \vspace*{0.3cm}  % 向下移动 namephoto 环境，以手动对齐图片
\fi
\name{迟猫猫}
\begin{basicinfo}
  \info{\email{1234@gmail.com}}
  \info{\phone{199 9999 8888}}
...
\ifshowphoto
  \photo{img/pic.png}
  \vspace{0.3cm}  % 您可以根据需要调整这个值，以下移正文内容，防止与照片重叠
\fi
